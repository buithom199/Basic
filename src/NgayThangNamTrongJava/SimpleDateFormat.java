...
public class SimpleDateFormat {
	...
	public static void main(String[] args) {
		...
		System.out.println("Thời gian hiện tại sau khi định dạng là" + sdf.format());
		
		//định dạng ngày giờ hiện tại theo cấu trúc 'dd/MM/yyy HH:mm:ss"
		//trong đó "HH" là giờ, "mm" là phút và "ss" là giây
		//"HH" là định dạng 24 giờ, và "hh" là định dạng 12 giờ
		SimpleDateFormat sdf2 = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		System.out.println("Ngày hiện tại sau khi định dạng là:" + sdf2.format());
		...
		System.out.println("Ngày giờ hiện tại sau khi định dạng là" + sdf3.format());
	}
